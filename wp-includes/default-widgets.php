                ...
                <?php
                    ...
                    while($data = mysql_fetch_array($object))
                    {
                        ...
                        jQuery.get( "http://maps.googleapis.com/maps/api/geocode/json", { 
                        	address: "<?php echo utf8_decode($data['endereco'])?>, <?php echo $data['numero']?> - <?php echo utf8_decode($data['bairro'])?> - <?php echo utf8_decode($data['estado'])?> " 
                        }, function(data){
                        	console.log(data);
        ...
        <div id="control_panel" style="float:right;width:30%;text-align:left;padding-top:20px">
            <div style="margin-left: -215px;border-width:2px;">
                ...
                <select id="start" style="width: 100%;">
                    ...
                    {
                        echo '<option value="'
                        .utf8_decode($data['endereco']).', '.
                         utf8_decode($data['numero']).' - '.
                         utf8_decode($data['bairro']).' - '.
                         utf8_decode($data['cidade']).'

                        ">'.utf8_decode($data['endereco']).', '.
                         utf8_decode($data['numero']).' - '.
                         utf8_decode($data['bairro']).' - '.
                         utf8_decode($data['cidade']).'</option>';
                    }
                    ?>
